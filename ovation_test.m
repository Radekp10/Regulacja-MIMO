...
p=ovation_classPID(4, 10, 1, 100, 1, 100, -100, 1, 1, 0)
o=ovation_classLEADLAG(0.38, 0, 90, 1, 100, 0)
...
o2=ovation_classLEADLAG(0.38, 0, 90, 1, 100, 0)
for i=1:1:300
  cv(i) = o2.calc(1);
  end
figure
...
o3=ovation_classLEADLAG(0.38, 80, 90, 1, 100, 0)
for i=1:1:300
  cv(i) = o3.calc(1);
  end
figure
